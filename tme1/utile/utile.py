...
def get_indice_etu_moins_prefere(master, matrice, dictionnaire):
    """retourne l'indice de l'etudiant accepté le moins préferé pour un master donné en parametre, à la fois
...
def get_position_originale_etu_recale(matrice, master, dictionnaire, indice_dict):
    """retourne l'indice de l'etudiant recalé dans la matrice d'origine"""
...
def get_master_rival(etu, dictionnaire):
    """retourne le master qui à deja accepté l'etudiant donné en parametre"""
...
def get_position_originale_master_recale(matrice, master):
    """retourne l'indice du master recalé dans la matrice d'origine"""
